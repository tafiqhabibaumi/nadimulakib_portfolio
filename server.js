...
`;
  ...
  const customSocialHTML = `
    <div class="relative flex flex-col items-center gap-20">
      <div class="absolute w-px h-[calc(100%+4rem)] border-l-2 border-dotted border-primary/50 -z-10 top-[-2rem]"></div>
      <div class="absolute w-2.5 h-2.5 rounded-full bg-primary -top-8 shadow-[0_0_10px_2px_rgba(var(--primary-rgb),0.7)]"></div>
      <div class="absolute w-1.5 h-1.5 rounded-full bg-primary top-[4.5rem] shadow-[0_0_8px_1px_rgba(var(--primary-rgb),0.5)]"></div>
      <div class="absolute w-1.5 h-1.5 rounded-full bg-primary top-[11.5rem] shadow-[0_0_8px_1px_rgba(var(--primary-rgb),0.5)]"></div>
      <div class="absolute w-2.5 h-2.5 rounded-full bg-primary -bottom-8 shadow-[0_0_10px_2px_rgba(var(--primary-rgb),0.7)]"></div>
      <a href="${data.hero.facebook || '#'}" target="_blank" class="flex items-center justify-center text-3xl border-2 border-primary p-3 rounded-full cursor-target hover:scale-125 duration-500 hover:shadow-lg hover:shadow-[#5227ff]/50 bg-[#030014]">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"></path></svg>
      </a>
      <a href="${data.hero.linkedin || '#'}" target="_blank" class="flex items-center justify-center text-3xl border-2 border-primary p-3 rounded-full cursor-target hover:scale-125 duration-500 hover:shadow-lg hover:shadow-[#5227ff]/50 bg-[#030014]">
      ...
      <a href="${data.hero.instagram || '#'}" target="_blank" class="flex items-center justify-center text-3xl border-2 border-primary p-3 rounded-full cursor-target hover:scale-125 duration-500 hover:shadow-lg hover:shadow-[#5227ff]/50 bg-[#030014]">
